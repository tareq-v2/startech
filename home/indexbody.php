				...
				<div class="row justify-content-center">
					...
					<div class="col-12 col-md-4 col-lg-2">
						<div class="product-cart">
							<div class="img-div">
								<img src="../admin/img/productimg/<?php print $product[0] ?>.jpg" style="width: 110%;" alt="lenovo">
							</div>
							<div class="p-detaits mt-2">
								<p><a href="?page=product&id=<?php print $product[0] ?>"><?php print $product[1] ?></a></p>
								<h6 class="price"><?php print $product[6] ?>৳</h6>
							</div>
						</div>
					</div>
					<?php
